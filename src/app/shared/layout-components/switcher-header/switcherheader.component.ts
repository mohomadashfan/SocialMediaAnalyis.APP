...
@Component({
  selector: "app-switcherheader",
  templateUrl: "./switcherheader.component.html",
  styleUrls: ["./switcherheader.component.scss"]
})
export class SwitcherHeaderComponent implements OnInit {
  private body: HTMLBodyElement | any = document.querySelector("body");
  public isCollapsed = true;

  constructor(private layoutService: LayoutService, public SwitcherService: SwitcherService, public navServices: NavService, private router: Router, private modalService: NgbModal) {
